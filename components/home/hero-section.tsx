...
export function HeroSection() {
  return (
    <section className="relative w-full h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full h-full flex flex-col lg:flex-row items-center justify-center px-6 max-w-7xl mx-auto">
        
        {/* Left Side - Text Content */}
        <div className="flex-1 flex flex-col justify-center items-start lg:pr-12">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-light text-ivory mb-6 leading-tight text-balance">
            More Than a Candle
            <span className="block text-gold">A Ritual</span>
          </h1>
          
          <p className="text-lg md:text-xl text-ivory/70 font-light mb-10 max-w-xl leading-relaxed">
            Handcrafted luxury candles designed to elevate your space. Each flame is a moment of pure indulgence.
          </p>

          <Link
            href="/products"
            className="inline-flex items-center justify-center px-8 py-4 border-2 border-[#D4AF37] text-[#D4AF37] bg-transparent rounded-lg text-lg font-light hover:bg-[#D4AF37] hover:text-black transition-all duration-300 group hover:shadow-lg hover:shadow-[#D4AF37]/50"
          >
            Shop Now
          </Link>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center lg:pl-12 mt-12 lg:mt-0">
